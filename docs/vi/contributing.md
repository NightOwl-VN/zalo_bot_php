...
- Tìm kiếm trong danh sách [GitHub Issues](https://github.com/NightOwl-VN/zalobot-sdk-php/issues) trước để tránh tạo trùng lặp.
...
4. **Mở Pull Request**:
   - Tạo PR vào nhánh `main` của repository `NightOwl-VN/zalobot-sdk-php`.
